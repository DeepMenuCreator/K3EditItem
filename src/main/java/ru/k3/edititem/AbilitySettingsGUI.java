...
public class AbilitySettingsGUI {
    ...
    private static final String TITLE_PREFIX = ColorUtils.color("&8[&bНастройки&8] ");
    ...
    public void open(Player player, String itemId, AbilityType abilityType) {
        ...
        // Уникальные настройки для конкретных способностей
    ...
    public static boolean isAbilitySettings(Inventory inv) {
